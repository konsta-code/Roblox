...
Nach dem Studio-Import in Workspace oder `ReplicatedStorage/MapAssets`
aktiviert `ImportedMapLoader.server.lua` automatisch die vollständige Mesh-Karte; die
